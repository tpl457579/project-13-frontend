...
const AnimalPopup = ({ isOpen, closePopup, dog, cat }) => {
  ...
  // Map cat/dog fields to common names
  const displayData = {
    name: animal.name,
    ...
    // Traits - map cat fields to dog fields
    ...
    protectiveness: animal.protectiveness, // Only dogs have this
    ...
    affection: isCat ? animal.affectionLevel : null // Cats have affection level
  }
  ...
  {displayData.lifeSpan && <p><strong>Life Span:</strong> {displayData.lifeSpan}</p>}
              ...
              <div className="traits-section">
                {isCat && <TraitMeter label="Affection Level" value={displayData.affection} />}
                <TraitMeter label={isCat ? "Energy Level" : "Playfulness"} value={displayData.playfulness} />
                {!isCat && <TraitMeter label="Energy" value={displayData.energy} />}
                <TraitMeter label="Shedding" value={displayData.shedding} />
                <TraitMeter label="Grooming" value={displayData.grooming} />
                {!isCat && <TraitMeter label="Protectiveness" value={displayData.protectiveness} />}
                <TraitMeter label="Good with Children" value={displayData.good_with_children} />
                <TraitMeter label={isCat ? "Dog Friendly" : "Good with Other Dogs"} value={displayData.good_with_other_dogs} />
                <TraitMeter label={isCat ? "Stranger Friendly" : "Good with Strangers"} value={displayData.good_with_strangers} />
